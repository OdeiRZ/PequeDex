export default {
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      submit: 'Send link',
      submitting: 'Sending...',
      successMessage: "If that email is registered, we've sent a link to reset your password.",
    ...
    resetPassword: {
      ...
      genericError: 'Could not reset the password. The link may have expired.',
      goToLogin: 'Log in',
    },
  },
  notFound: {
  ...
  dashboard: {
    ...
    hero: {
      eyebrow: 'Today with {name}',
      eyebrowGeneric: 'Today',
      ageDaysUnit: 'day | days',
      ageWeeksUnit: 'week | weeks',
      countdownToday: 'Could be today!',
      bornOn: 'Born on {date}',
      dueOn: 'Due date: {date}',
      sexBoy: '💙 Boy',
      sexGirl: '🌸 Girl',
